    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label" for="wk-content-max-width">{{'Content Max Width' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-content-max-width" class="uk-form-width-medium" ng-model="widget.data['content_max_width']">
