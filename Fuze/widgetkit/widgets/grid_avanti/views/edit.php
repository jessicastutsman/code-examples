                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        ...
                        <p class="uk-form-controls-condensed" ng-if="widget.data['filter'] != 'none'">
                            <label>
                                <input class="uk-form-width-1-1" type="text" ng-model="widget.data['tag-list']" ng-list placeholder= "{{ 'Leave empty for auto list' | trans }}"> {{ 'Filter tag list' | trans }}
                            </label>
                        </p>
                ...
                <div class="uk-form-row">
                    ...
                    <div class="uk-form-controls">
                        <select id="wk-panel" class="uk-form-width-medium" ng-model="widget.data['panel']">
                            ...
                            <option value="space-horizontal">{{'Space Horizontal' | trans}}</option>
