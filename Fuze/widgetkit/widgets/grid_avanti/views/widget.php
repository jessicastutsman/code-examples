...
switch ($settings['panel']) {
    ...
    case 'space-horizontal' :
        $panel .= ' tm-panel-space-horizontal';
        break;
    case 'sequence1' :
        $panel .= ' uk-panel-box';
...
switch ($settings['badge_style']) {
    ...
    case 'danger':
        ...
        break;
    case 'danger':
        $badge_style = 'uk-badge tm-badge-muted';
        break;
    case 'text-muted':
...
<div id="wk-grid<?php echo $settings['id']; ?>" class="<?php echo $grid; ?> uk-text-<?php echo $settings['text_align']; ?> tm-grid-avanti <?php echo $settings['class']; ?>" <?php echo $grid_js ?> <?php echo $animation; ?>>
