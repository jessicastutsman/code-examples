    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Overlay' | trans}}</span>
                     <div class="uk-form-controls uk-form-controls-text">
                         <label><input type="checkbox" ng-model="widget.data['overlay']"> {{'Enable overlay' | trans}}</label>
                         <select id="wk-overlay" class="uk-form-width-medium" ng-model="widget.data['overlay_layout']" ng-if="widget.data.overlay">
                             <option value="center">{{'Center' | trans}}</option>
                             <option value="middle-left">{{'Center Left' | trans}}</option>
                             <option value="middle-right">{{'Center Right' | trans}}</option>
                         </select>
                         <p class="uk-form-controls-condensed" ng-if="widget.data.overlay">
                             <select class="uk-form-width-medium" ng-model="widget.data['overlay_content_width']">
                                 <option value="100">{{'100%' | trans}}</option>
                                 <option value="75">{{'75%' | trans}}</option>
                                 <option value="66">{{'66%' | trans}}</option>
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <span class="uk-form-label">{{'Animation' | trans}}</span>
                    <div class="uk-form-controls uk-form-controls-text">
                        <label><input type="checkbox" ng-model="widget.data['title_animation']"> {{'Enable Title Animation' | trans}}</label>
                    </div>
                </div>
