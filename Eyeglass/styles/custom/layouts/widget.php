...
else if (in_array($widget->position, array('toolbar-h','toolbar-r' ,'toolbar-l', 'footer-left', 'footer-right', 'offcanvas'))) {
    $panel = 'uk-panel';
}
...
// Set title
if (in_array($widget->position, array('toolbar-h','toolbar-r' ,'toolbar-l', 'footer-left', 'footer-right', 'smoothscroll'))) {
    $title = '';
...
if ($widget->menu) {
    ...
    } else if (in_array($widget->position, array('toolbar-h','toolbar-l', 'toolbar-r', 'footer-left', 'footer-right'))) {
        $renderer = 'subnav';
