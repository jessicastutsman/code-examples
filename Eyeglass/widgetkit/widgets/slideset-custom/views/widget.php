...
// JS Options
$options = array();
$options[] = ($settings['infinite']) ? 'infinite: true' : '';
...
<div class="<?php echo $position_relative; ?> <?php echo $settings['class']; ?>" data-uk-slider="<?php echo $options; ?>">
   ...
   <div class="uk-slider-container <?php echo $grid; ?>">

        <ul class="uk-slider uk-flex-middle">
        <?php foreach ($items as $item) :
				...
				if ($settings['slidenav'] == 'default') {
				$class = 'class="uk-slidenav-position"';
					} else {
						$class = 'class="uk-position-static"';
					}
            ...
            <li<?php echo $filter; ?> <?php echo $class;?>>
