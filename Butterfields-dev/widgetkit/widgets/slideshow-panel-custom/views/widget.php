            ...
            $meta .= $app['translator']->trans('Posted in %categories%',  array('%categories%' => $categories));
                ...
                <li>
					...
					<h3 class="<?php echo $title_size; ?>">
                        ...
                        <span class="uk-margin-small-left <?php echo $badge_style; ?>"><?php echo $meta['date'] ; ?><?php echo $item['badge']; ?></span>
                        <?php endif; ?>

                    </h3>
					</div>
					<?php if ($meta) : ?>
        		    <div class="uk-article-meta custom uk-text-primary">
						<div class="date-meta"><?php
						$dateyear=date_create($item['date']);
						echo date_format($dateyear,"d");?></div>
						
						<div class="month-meta"><?php
						$dateyear=date_create($item['date']);
						echo date_format($dateyear,"M");?>
						</div>
					</div>
		            <?php endif; ?>
					</div>
					...
					<?php if ($meta) : ?>
            		<p class="uk-article-meta custom">Posted by <strong><?php echo $item['author']; ?></strong></p>
           			<?php endif; ?>
